...
// shortcuts
     ...
     */
    title.tcCheckCssClasses1 = function (tcExecuteBeforeTest, tcExecuteAfterTest) {
        return new h.TestCase("Check the CSS classes #1",{
            ...
            .assert.isTrue(function () {
                return !h.find(itemSelector.title,"#ContentFrame").parent().hasClass("c1") &&
                    !h.find(itemSelector.title,"#ContentFrame").parent().hasClass("c2")})
            ;
     ...
     */
    title.tcCheckCssClasses2 = function (tcExecuteBeforeTest, tcExecuteAfterTest) {
     ...
     * -> the wrapper div of the title component has no classes
     */
    title.tcCheckCssClasses3 = function (tcExecuteBeforeTest, tcExecuteAfterTest) {
     ...
     */
    title.tcCheckCssClasses4 = function (tcExecuteBeforeTest, tcExecuteAfterTest) {
        return new h.TestCase("Check the CSS classes #4",{
            ...
            .assert.isTrue(function () {
                return h.find(itemSelector.title,"#ContentFrame").parent().hasClass("c2")})
            ;
    ...
    //.addTestCase(titleV1.tcSetTitleValueUsingInlineEditor(itemSelector, tcExecuteBeforeTest, tcExecuteAfterTest))
        ...
        .addTestCase(title.tcCheckCssClasses1(tcExecuteBeforeTest, tcExecuteAfterTest))
        .addTestCase(title.tcCheckCssClasses2(tcExecuteBeforeTest, tcExecuteAfterTest))
        .addTestCase(title.tcCheckCssClasses3(tcExecuteBeforeTest, tcExecuteAfterTest))
        .addTestCase(title.tcCheckCssClasses4(tcExecuteBeforeTest, tcExecuteAfterTest))

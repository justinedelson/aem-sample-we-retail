...
;(function(h, $){
    ...
    var formText = window.CQ.WeRetailIT.FormText;
     ...
     * Before Test Case
     */
    formText.tcExecuteBeforeTest = function() {
        ...
        // common set up
            ...
            .execFct(function (opts, done) {
                c.addComponent(c.rtFormText, h.param("testPagePath")(opts) + c.relParentCompPath, "cmpPath", done)
            })
     ...
     */
    formText.setHelpMessage = function(tcExecuteBeforeTest, tcExecuteAfterTest) {
    ...
    var tcExecuteBeforeTest = formText.tcExecuteBeforeTest();
    var tcExecuteAfterTest = formText.tcExecuteAfterTest();

    /**
     * The main test suite for Text Component
     */
    new h.TestSuite('We.Retail Tests - Form Text', {path: '/apps/weretail/tests/admin/components-it/FormText.js',
        ...
        .addTestCase(formText.setHelpMessage(tcExecuteBeforeTest, tcExecuteAfterTest))
